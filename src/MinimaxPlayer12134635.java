...
public class MinimaxPlayer12134635 extends AIPlayer {
	 ...
	 * Constructor
	 */
	public MinimaxPlayer12134635(String aName, EvaluationFunction ef) {
		super(aName, ef);
	...
	private double evalManyMove(Board b, HexCoord aMove) {
		...
		MinimaxPlayer12134635 whiteCopy = new MinimaxPlayer12134635(
				"WhiteCopy", evalFunc);
		MinimaxPlayer12134635 blackCopy = new MinimaxPlayer12134635(
				"BlackCopy", evalFunc);
